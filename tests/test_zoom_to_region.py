...
class TestAddZoomToRegion:
    ...
    def test_custom_center_produces_translation(self, project, mock_clip):
        ...
        assert pos_kfs[2][1] == (expected_tx, expected_ty)
        assert pos_kfs[3][1] == (expected_tx, expected_ty)
        # Start/end should be zero
        assert pos_kfs[0][1] == (0.0, 0.0)
        assert pos_kfs[4][1] == (0.0, 0.0)
